...
export function HeatUpGlyph({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 28" className={className} aria-hidden>
      ...
      <line x1="22" y1="23" x2="36" y2="23" stroke="#cfd6dd" strokeWidth="3" strokeLinecap="round" />
    </svg>
  );
}
...
export function DoorGlyph({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 28 28" className={className} aria-hidden>
      ...
      <path d="M20 4 l4 3 v14 l-4 3" fill="none" stroke={S} strokeWidth="2.2" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ProbeGlyph({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 28" className={className} aria-hidden>
      ...
      <polyline points="25,14 29,14 27,17" fill="none" stroke={S} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

const paths: Record<Exclude<ButtonIcon, 'none'>, ReactElement> = {
  left: <polyline points="16,5 8,12 16,19" fill="none" stroke={S} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />,
  right: <polyline points="8,5 16,12 8,19" fill="none" stroke={S} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />,
  confirm: (
    <path d="M18 5 v6 a3 3 0 0 1 -3 3 H7 m0 0 l4 -4 m-4 4 l4 4" fill="none" stroke={S} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
  ),
  clear: (
    <text x="12" y="17" textAnchor="middle" fontSize="15" fontWeight="700" fill={S} fontFamily="sans-serif">
      C
    </text>
  ),
  ...
  timer: (
    <>
      ...
      <path d="M12 8 v5 l4 2" fill="none" stroke={S} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </>
  ),
  settings: (
    <path
  ...
  lockOff: (
    <>
      <rect x="6" y="11" width="12" height="9" rx="1.5" fill="none" stroke={S} strokeWidth="2" />
      <path d="M8.5 11 V8 a3.5 3.5 0 0 1 7 -1.5" fill="none" stroke={S} strokeWidth="2" strokeLinecap="round" />
    </>
  ),
